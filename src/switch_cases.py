def switch_cases(str1: str, str2: str) -> str:
    ...
    - If str2 character is lowercase, corresponding str1 character becomes uppercase
    - If str2 character is uppercase, corresponding str1 character becomes lowercase
    ...
    for i in range(min_length):
        # Invert case based on str2's character case
        if str2[i].islower():
            result += str1[i].upper()
        else:
            result += str1[i].lower()
